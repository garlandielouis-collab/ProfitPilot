    ...
    <div className="min-h-screen bg-surface">
      <div className="mx-auto max-w-3xl px-5 py-16 md:px-10">
        ...
        <div className="rounded-2xl border border-border bg-white p-8 shadow-sm space-y-6 text-sm leading-7 text-slate-600">
          ...
          <section><h2 className="font-bold text-primary mb-2">4. Pwopriete Entèlèktyèl</h2><p>Tout kontni ProfitPilot (logo, kòd, konsèp) se pwopriyete ProfitPilot. Done ou yo rès pwopriyete pa w.</p></section>
          <section><h2 className="font-bold text-primary mb-2">5. Limit Responsablite</h2><p>ProfitPilot pa responsab pou okenn pèt finansye ki rezilte de itilizasyon aplikasyon an. Done yo bay pou enfòmasyon sèlman.</p></section>
          <section><h2 className="font-bold text-primary mb-2">6. Kontakte Nou</h2><p>Pou nenpòt kesyon legal: <a href="mailto:garlandielouis178@gmail.com" className="text-accent hover:underline">garlandielouis178@gmail.com</a></p></section>
        </div>
      </div>
    </div>
  );
