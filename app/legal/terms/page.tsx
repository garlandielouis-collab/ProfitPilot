    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      <div className="mx-auto max-w-3xl px-5 py-16 md:px-10">
        ...
        <div className="mb-8">
          ...
          <h1 className="mt-2 text-3xl font-extrabold text-[#001f3f]">Kondisyon Itilizasyon</h1>
        ...
        <div className="rounded-2xl border border-[#E2E8F0] bg-white p-8 shadow-sm space-y-6 text-sm leading-7 text-slate-600">
          <section><h2 className="font-bold text-[#001f3f] mb-2">1. Akseptasyon Kondisyon yo</h2><p>Lè ou itilize ProfitPilot, ou aksepte kondisyon sa yo. Si ou pa dakò, tanpri pa itilize sèvis la.</p></section>
          <section><h2 className="font-bold text-[#001f3f] mb-2">2. Deskripsyon Sèvis la</h2><p>ProfitPilot se yon aplikasyon jèsyon biznis pou antreprenè ayisyen. Li ofri jesyon envantè, vant, acha, depans ak rapò finansye.</p></section>
