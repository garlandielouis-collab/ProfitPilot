    ...
    <div className="min-h-screen bg-surface">
      <div className="mx-auto max-w-3xl px-5 py-16 md:px-10">
        ...
        <div className="rounded-2xl border border-border bg-white p-8 shadow-sm space-y-6 text-sm leading-7 text-slate-600">
              ...
              {[['sb-*-auth-token', 'Sesyon otantifikasyon Supabase', 'Nesesè'],
                ...
                <li key={name} className="rounded-xl border border-border p-3">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="rounded-full bg-slate-100 px-2 py-0.5 text-note font-semibold text-slate-500">{type}</span>
                  </div>
          ...
          <section><h2 className="font-bold text-primary mb-2">Kontwole Cookies</h2><p>Ou ka efase cookies nan paramèt navigatè ou. Atansyon: sa ka dekonekte ou nan ProfitPilot.</p></section>
        </div>
      </div>
    </div>
  );
