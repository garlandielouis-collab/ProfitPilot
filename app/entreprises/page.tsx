        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input {...field('name')} placeholder="Mon Entreprise SARL"
              className="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none focus:border-[#001F3F]/40 focus:bg-white" />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select {...field('sector')}
                className="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none focus:border-[#001F3F]/40">
          ...
          <div>
            ...
            <textarea {...field('address')} rows={2} placeholder="Rue des Miracles, Port-au-Prince"
              className="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none focus:border-[#001F3F]/40 resize-none" />
          </div>
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <button type="submit" disabled={pending}
              className="flex items-center gap-2 rounded-xl bg-[#001F3F] px-5 py-2.5 text-sm font-bold text-white hover:bg-[#002D5B] disabled:opacity-50">
              {pending && <Spinner sm />}
...
export default function EntreprisesPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6">
      {/* Toast */}
      {toast && (
        <div className="fixed bottom-6 left-1/2 z-[100] -translate-x-1/2 rounded-2xl bg-[#001F3F] px-6 py-3 text-sm font-semibold text-white shadow-xl">
          {toast}
        </div>
      )}
      ...
      <div className="mb-8 flex items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-[#001F3F]">Mes entreprises</h1>
        ...
        <div className="flex gap-3">
          <button
            ...
            className={`rounded-xl border px-4 py-2.5 text-sm font-semibold transition ${showArchived ? 'border-[#001F3F] bg-[#001F3F] text-white' : 'border-slate-200 text-slate-600 hover:bg-slate-50'}`}>
            {showArchived ? '← Actives' : 'Archivées'}
          </button>
          <button
            onClick={() => setModal('create')}
            className="flex items-center gap-2 rounded-xl bg-[#001F3F] px-4 py-2.5 text-sm font-bold text-white hover:bg-[#002D5B]">
            ...
            return (
              <div key={c.id}
                ...
                <div className="flex items-center gap-4 p-5">
                  {/* Avatar */}
                  <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl bg-[#EAF1F8] text-lg font-bold text-[#001F3F]">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {!c.isOwner && (
                        <span className="rounded-full bg-blue-50 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-blue-500">
                          Membre · {c.memberRole}
                        </span>
                      )}
                    </div>
                  ...
                  <div className="flex flex-shrink-0 items-center gap-1">
                    ...
                    {c.isOwner && !c.archivedAt && (
                      <button
                        ...
                        className="flex items-center gap-1.5 rounded-xl bg-[#001F3F] px-3 py-2 text-xs font-bold text-white hover:bg-[#002D5B] disabled:opacity-50">
