...
export async function getReportsDataAction(
  ...
  const balance: BalanceSheetData = {
    terrains:               accountBalance('2100'),
    batimentsConstruct:     accountBalance('2200'),
    materielInformatique:   accountBalance('2420'),
    mobilierBureau:         accountBalance('2410'),
    vehicules:              accountBalance('2500'),
    autresImmobilisations:  0,
    amortissementsCumules:  accountBalance('2800'),
    stocksMarchandises:     accountBalance('3700') > 0 ? accountBalance('3700') : stockValue + incomeBuckets.variationStock,
    creancesClients:        accountBalance('4110') > 0 ? accountBalance('4110') : creancesClients,
    avancesFournisseurs:    accountBalance('4710'),
    tresorerieCaisse:       accountBalance('5310'),
    tresoreriebanque:       accountBalance('5110'),
    tresorerieMonCash:      accountBalance('5121'),
    tresorerieNatcash:      accountBalance('5122'),
    autresActifsCourants:   0,
    capitalSocial:           accountBalance('1010'),
    apportsProprio:          0,
    reservesLegales:         accountBalance('1070'),
    reportANouveau:          accountBalance('1070'),
    resultatExercice:        netProfit,
    prelevementsProprietaire: accountBalance('4580'),
    empruntsBancairesLT:     accountBalance('1640'),
    pretesLT:                accountBalance('1620'),
    dettesImmobilisations:   0,
    detteFournisseurs:       accountBalance('4010') > 0 ? accountBalance('4010') : detteFournisseurs,
    salairesPayer:           accountBalance('4200'),
    onaPayer:                accountBalance('6430'),
    taxesPayer:              accountBalance('4440'),
    chargesPayer:            accountBalance('4810'),
    avancesClients:          accountBalance('4190'),
