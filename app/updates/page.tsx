...
const UPDATES = [
  { version: 'v2.4', date: 'Jen 2026', badge: 'Nouvo', color: 'bg-accent text-primary', items: ['Paj Envantè redesign konplè', 'Top pwodui pa vant ajoute', 'Upload foto pwodui fonksyonèl', 'Vitès chajman amelyore 3x'] },
  ...
  return (
    <div className="min-h-screen bg-surface">
      <div className="mx-auto max-w-3xl px-5 py-16 md:px-10">
        ...
        <div className="mb-12">
          <span className="text-xs font-bold uppercase tracking-widest text-accent">{t({ fr: 'Mises à jour', ht: 'Changelog' })}</span>
          <h1 className="mt-2 text-3xl font-extrabold text-primary">{t({ fr: 'Dernières nouvelles', ht: 'Dènye Mizajou' })}</h1>
