      ...
      <div className="w-full max-w-xl overflow-hidden rounded-surface bg-white text-anthracite shadow-2xl sm:mx-4">
        <div className="flex items-center justify-between border-b border-slate-200 px-6 py-5">
          ...
          <button
            type="button"
            onClick={onClose}
            className="min-h-touch min-w-touch inline-flex items-center justify-center rounded-full border border-slate-200 bg-slate-100 px-3 py-2 text-sm font-semibold text-anthracite transition hover:bg-slate-200"
          >
