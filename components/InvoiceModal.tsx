    ...
    <div id="pp-invoice-print" className="bg-white text-[#212529]">
      ...
      <div className="flex items-start justify-between mb-8">
        <div>
          ...
          <p className="mt-1 text-xs text-slate-400 uppercase tracking-widest">Facture Officielle</p>
        </div>
        <div className="text-right">
          <p className="text-xs text-slate-400 uppercase tracking-wider">Fakti #</p>
      ...
      <div className="rounded-xl border border-slate-100 bg-slate-50 p-4 mb-6">
        <p className="text-xs uppercase tracking-widest text-slate-400 mb-1">Faktire pou</p>
        <p className="font-semibold text-[#212529] text-lg">{invoice.client_name ?? 'Kliyan Anonim'}</p>
      </div>
      ...
      <table className="w-full text-sm mb-6 border-collapse">
        <thead>
          <tr className="bg-[#0056b3] text-white">
            <th className="px-3 py-2.5 text-left font-semibold rounded-tl-lg">Pwodui</th>
            <th className="px-3 py-2.5 text-right font-semibold">Qté</th>
            <th className="px-3 py-2.5 text-right font-semibold">Pri Unit.</th>
            <th className="px-3 py-2.5 text-right font-semibold">Rabè</th>
            <th className="px-3 py-2.5 text-right font-semibold rounded-tr-lg">Total</th>
          </tr>
        </thead>
        <tbody>
      ...
      <div className="flex justify-end">
        <div className="w-full max-w-xs space-y-2">
          ...
          <div className="flex justify-between items-center border-t-2 border-[#0056b3] pt-2">
            <span className="font-extrabold text-lg text-[#212529]">TOTAL</span>
      ...
      <div className="mt-10 border-t border-slate-200 pt-4 text-center text-xs text-slate-400">
        Dokiman sa a jenere pa <strong>{businessName}</strong> via ProfitPilot · {new Date().toLocaleDateString('fr-FR')}
      </div>
    </div>
  );
}
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="w-full max-w-2xl rounded-3xl border border-slate-200 bg-white shadow-2xl flex flex-col max-h-[92vh]">
        ...
        <div className="no-print flex items-center justify-between border-b border-slate-100 px-6 py-4 shrink-0">
          <div>
            <h2 className="font-bold text-[#212529]">Fakti Ofisyèl</h2>
