  ...
  return (
    <>
      <motion.nav
        ...
        style={{
          background: scrolled ? 'rgba(11,15,25,0.94)' : 'rgba(11,15,25,0.6)',
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-semibold text-white">ProfitPilot</span>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          {!user ? (
            <>
              <Link
                href="/auth/login"
                className="hidden rounded-xl border border-white/10 px-4 py-2 text-sm text-slate-300 transition hover:border-white/20 hover:text-white sm:block"
              >
